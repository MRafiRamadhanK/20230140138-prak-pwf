            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="text-2xl font-bold tracking-tight">Add New Supplier</h2>
                    </div>
                    ...
                    <form action="{{ route('suppliers.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. PT Maju Bersama" 
                        ...
                        <div>
                            ...
                            <input type="text" id="contact" name="contact" value="{{ old('contact') }}" placeholder="e.g. 08123456789" 
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" rows="3" placeholder="e.g. Jl. Raya No. 123, Jakarta" 
                                class="w-full px-4 py-2.5 rounded-lg border text-sm @error('address') border-red-500 @enderror bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 focus:ring-indigo-500 focus:border-indigo-500">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
