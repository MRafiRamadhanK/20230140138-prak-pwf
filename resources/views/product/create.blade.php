                    ...
                    <form action="{{ route('product.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. Wireless Headphones" 
                                class="w-full px-4 py-2.5 rounded-lg border text-sm @error('name') border-red-500 @enderror bg-white dark:bg-gray-700">
                            @error('name')
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" id="price" name="price" value="{{ old('price') }}" placeholder="0" step="1" 
                                    class="w-full px-4 py-2.5 rounded-lg border text-sm @error('price') border-red-500 @enderror bg-white dark:bg-gray-700">
                                @error('price')
                                    <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                            <a href="{{ route('product.index') }}" class="px-4 py-2.5 rounded-lg border border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 transition">
                                Cancel
                            </a>
